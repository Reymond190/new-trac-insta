...
public class ServiceimageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ServiceimageActivity.this, "Submitted successfully", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public void EnableRuntimePermission(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(ServiceimageActivity.this,
                Manifest.permission.CAMERA))
        {

            Toast.makeText(ServiceimageActivity.this,"CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(ServiceimageActivity.this,new String[]{
        ...
        switch (RC) {
            ...
            case RequestPermissionCode:
                ...
                if (PResult.length > 0 && PResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ServiceimageActivity.this,"Permission Granted, Now your application can access CAMERA.", Toast.LENGTH_LONG).show();

                } else {

                    Toast.makeText(ServiceimageActivity.this,"Permission Canceled, Now your application cannot access CAMERA.", Toast.LENGTH_LONG).show();
    ...
    public void backbutton(View view) {
        Intent intent = new Intent(ServiceimageActivity.this,HomeActivity.class);
